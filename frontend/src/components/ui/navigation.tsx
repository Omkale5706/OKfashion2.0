      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/services" className="text-text-primary hover:text-primary transition-colors">
              Services
            </Link>
            <Link
              to="/ai-stylist"
            ...
            {user && (
              <>
                ...
                <Link to="/dashboard" className="text-text-primary hover:text-primary transition-colors">
                  Dashboard
                </Link>
              </>
            )}
            {user && user.isAdmin && (
              <Link to="/admin" className="text-text-primary hover:text-primary transition-colors">
                Admin
              </Link>
            )}
          </div>
