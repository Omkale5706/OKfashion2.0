      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#outfit" className="text-gray-300 hover:text-white transition-colors">
                  Outfit Recommendations
                </Link>
              </li>
              <li>
                <Link to="/services#hairstyle" className="text-gray-300 hover:text-white transition-colors">
                  Hairstyle Suggestions
                </Link>
              </li>
              <li>
                <Link to="/services#color" className="text-gray-300 hover:text-white transition-colors">
                  Color Analysis
                </Link>
              </li>
              <li>
                <Link to="/services#style" className="text-gray-300 hover:text-white transition-colors">
                  Style Transformation
                </Link>
              </li>
              <li>
                <Link to="/scan-style" className="text-gray-300 hover:text-white transition-colors">
                  Scan Your Style
                </Link>
              </li>
            </ul>
